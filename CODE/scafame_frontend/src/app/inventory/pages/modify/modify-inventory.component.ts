      ...
      <div class="max-w-[1200px] mx-auto w-full flex flex-col items-center justify-center relative">
        ...
        <div class="flex flex-wrap gap-10 justify-center items-start">
          ...
          <div class="bg-black text-white rounded-2xl p-6 w-72 flex flex-col items-center">
            <iconify-icon icon="mdi:scale-balance" class="text-white text-6xl mb-4"></iconify-icon>
            <h2 class="text-2xl font-bold mb-6">Unidades</h2>

            <app-button label="Agregar Unidad" variant="dark" class="mb-3 w-full" (click)="goTo('unit/add')" />
            <app-button label="Editar Unidad" variant="dark" class="mb-3 w-full" (click)="goTo('unit/edit')" />
            <app-button label="Eliminar Unidad" variant="dark" class="w-full" (click)="goTo('unit/delete')" />
          </div>
        ...
        <div
          class="flex justify-center mt-10
                lg:absolute lg:-right-6 lg:bottom-1 lg:mt-0"
        >
