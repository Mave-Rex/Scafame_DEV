  ...
  template: `
    <main class="p-8 font-display min-h-[calc(90vh-120px)] flex items-center">
      <div class="max-w-[1200px] mx-auto w-full flex flex-col items-center justify-center relative">
        ...
        <h1 class="text-4xl font-bold text-black text-center mb-5">Agregar Área</h1>

        <app-ingreso-formulario [tipo]="'Área'"></app-ingreso-formulario>
...
export class AddAreaPageComponent {
