  ...
  template: `
    <main class="p-8 font-display min-h-[calc(100vh-120px)] flex items-center">
      <div class="max-w-[1100px] mx-auto w-full flex flex-col items-center justify-center relative">
        ...
        <h1 class="text-4xl font-bold text-black text-center mb-5">Eliminar Área</h1>

        <app-eliminar-formulario [tipo]="'Área'"></app-eliminar-formulario>
...
export class DeleteAreaPageComponent {
